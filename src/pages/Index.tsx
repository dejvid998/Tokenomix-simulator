        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <Card className="p-4 md:p-6 backdrop-blur-xl bg-white/90 dark:bg-zinc-900/90 border border-zinc-200/50 dark:border-zinc-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 rounded-2xl h-[400px]">
